...
- Name: checkout.spec.ts >> Checkout >> stacks two coupons
- Location: tests/checkout.spec.ts:20:7

# Error details

```
Error: second coupon should appear in order summary

expect(received).toContain(expected) // indexOf

Expected value: "FREESHIP -$5.00"
Received array: ["SAVE10 -$9.90"]
```
