...
- Name: checkout.spec.ts >> Checkout >> completes purchase with saved card
- Location: tests/checkout.spec.ts:35:7

# Error details

```
Error: Timed out waiting for order confirmation: spinner still visible after 30000ms
