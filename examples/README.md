...
| File | Shows |
|---|---|
| [01-tag-your-tests.spec.ts](01-tag-your-tests.spec.ts) | Plain tags (`@P0`, `@owner:x`, `@story:x`), describe-level tags, annotations; `meta()` shortcut |
| [02-logs-and-test-data.spec.ts](02-logs-and-test-data.spec.ts) | `console.log` and JSON / CSV attachments rendered as logs, key/value and tables; `log()` / `testData()` shortcuts |
