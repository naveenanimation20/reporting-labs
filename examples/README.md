...
Small, self-contained spec files that show every reportingLabs feature. They use `page.setContent()` and `page.route()` instead of a real website, so they run anywhere, offline, in a few seconds.
