...
function header(){
  ...
  return h('header',{class:'hdr'},
    data.options.logo ? h('img',{src:data.options.logo,alt:''}) : h('div',{class:'logo',title:'Generated by reporting-labs','aria-label':'reporting-labs'}, document.getElementById('rl-logo').content.cloneNode(true)),
